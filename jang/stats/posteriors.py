...
def compute_etot_posterior(variables: List[PosteriorVariable], detector: Detector, gw: GW, parameters: Parameters) -> Tuple[np.ndarray, np.ndarray]:
...
def compute_fnu_posterior(variables: List[PosteriorVariable], detector: Detector, gw: GW, parameters: dict) -> Tuple[np.ndarray, np.ndarray]:
