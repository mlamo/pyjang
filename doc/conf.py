...
version = get_distribution("jang").version
short_version = ".".join(version.split(".")[:2])
project = "jang {}".format(short_version)
copyright = "{0}, Mathieu Lamoureux".format(date.today().year)
...
html_title = "jang {}".format(version)
